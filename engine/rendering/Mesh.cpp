...
namespace palmx
{
    Mesh::Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices, const Texture& albedoTexture, const Texture& normalTexture)
    ...
    const Texture& Mesh::GetAlbedoTexture() const
    {
