...
PalmEngine::Mesh::Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<Texture> textures)
{
    mVertices = vertices;
    mIndices = indices;
    mTextures = textures;
...
void PalmEngine::Mesh::Draw(Shader& _shader)
{
    ...
    for (unsigned int i = 0; i < mTextures.size(); i++)
    {
        ...
        glUniform1i(glGetUniformLocation(_shader.mID, (name + number).c_str()), i);
...
void PalmEngine::Mesh::SetupMesh()
{
