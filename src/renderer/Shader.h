...
#define DEFAULT_SHADER_VERTEX std::string(palmx::ResourceManager::GetProjectRootDirectory() + "/data/shaders/shader.vert").c_str()
#define DEFAULT_SHADER_FRAGMENT std::string(palmx::ResourceManager::GetProjectRootDirectory() + "/data/shaders/shader.frag").c_str()
